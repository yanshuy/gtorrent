...
-type pool(GNZ, GOA) :: {pool,
        fun((GNZ, glisten@internal@handler:loop_message(GOA), glisten@internal@handler:connection(GOA)) -> glisten@internal@handler:next(GNZ, glisten@internal@handler:loop_message(GOA))),
        integer(),
        fun((glisten@internal@handler:connection(GOA)) -> {GNZ,
